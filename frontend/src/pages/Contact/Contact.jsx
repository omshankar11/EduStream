  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with EduStream. Connect with us on social media or send us a message."
        />
        <link rel="canonical" href="https://EduStream.netlify.app/contact" />
      </Helmet>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Lucknow, India 226201</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a
                    href="mailto:omshankartiwari94@gmail.com"
                    className="text-gray-600 hover:text-indigo-600 transition-colors"
                  >
                    omshankartiwari94@gmail.com
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/omshankar11"
                  target="_blank"
                ...
                <a
                  href="https://leetcode.com/u/OmShankar11/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.linkedin.com/in/om-shankar-tiwari9651/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BYJR2Mx2vQ1%2ByZID3gOZh3w%3D%3D"
                  target="_blank"
                  rel="noopener noreferrer"
